...
// ---------------- MENU ----------------
export async function getMenu() {                                     //Fetches list of all pizzas from backend
  ...
  const data = await res.json();                                       // if not Returns actual menu items
  return data.data;
}

// ---------------- GET SINGLE ORDER ----------------
export async function getOrder(id) {                                       //Gets one order by ID
...
// ---------------- CREATE ORDER ----------------
export async function createOrder(newOrder) {                                        //Sends new order to backend
...
// ---------------- UPDATE ORDER ----------------
export async function updateOrder(id, updateObj) {                                            //Updates existing order partially
